...
public class SunCurvyLines001 extends AbstractSun 
{
    ...
    public SunCurvyLines001(PGraphics graphics) 
    {
        this(graphics.width / 2, graphics.height / 2, graphics.width, graphics.height, graphics);
    }

    public SunCurvyLines001(int x, int y, int width, int height, PGraphics graphics) 
    {
    ...
    private class Ray implements ISunRay 
    {
        ...
        public void Draw() 
        {
            ...
            Graphics.noStroke();
            Graphics.fill(Graphics.color(Color, Alpha()));
            Graphics.circle(x, y, 4f * _scale);
