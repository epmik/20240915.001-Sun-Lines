...
public class Easing 
{
    ...
    public static double NormalizedTime(double time, double min, double max) 
    {
        return NormalizedTime(time, min, max, true);
    };

    public static double NormalizedTime(double time, double min, double max, boolean clamp) 
    {
        var n = (time - min) / (max - min);

        return clamp ? Math.Min(Math.Max(n, 0), 1) : n;
    };

    public static float NormalizedTime(float time, float min, float max) 
    {
        return NormalizedTime(time, min, max, true);
    };

    public static float NormalizedTime(float time, float min, float max, boolean clamp) 
    {
        var n = (time - min) / (max - min);
    ...
    public static double InQuadratic(double time, double min, double max) 
    {
        return InQuadratic(NormalizedTime(time, min, max));
    };
    ...
    // quadratic easing in/out - acceleration until halfway, then deceleration
    public static double OutQuadratic(double time, double min, double max) 
    {
        return OutQuadratic(NormalizedTime(time, min, max));
    };
    ...
    // quadratic easing in/out - acceleration until halfway, then deceleration
    public static double InOutQuadratic(double time, double min, double max) 
    {
        return InOutQuadratic(NormalizedTime(time, min, max));  
    };
