...
public class Icosahedron
{
    ...
    public List<Vector3> Positions = new ArrayList<Vector3>();
    ...
    public int AddVertex(Vector3 p)
    {
        ...
        Positions.add(new Vector3(p.X / length, p.Y / length, p.Z / length));
    ...
    public static Icosahedron Create(int recursionLevel)
    {
        ...
        icosahedron.AddVertex(new Vector3(-1,  t,  0));
        icosahedron.AddVertex(new Vector3( 1,  t,  0));
        icosahedron.AddVertex(new Vector3(-1, -t,  0));
        icosahedron.AddVertex(new Vector3( 1, -t,  0));

        icosahedron.AddVertex(new Vector3( 0, -1,  t));
        icosahedron.AddVertex(new Vector3( 0,  1,  t));
        icosahedron.AddVertex(new Vector3( 0, -1, -t));
        icosahedron.AddVertex(new Vector3( 0,  1, -t));

        icosahedron.AddVertex(new Vector3( t,  0, -1));
        icosahedron.AddVertex(new Vector3( t,  0,  1));
        icosahedron.AddVertex(new Vector3(-t,  0, -1));
        icosahedron.AddVertex(new Vector3(-t,  0,  1));
